<table cellspacing="10" cellpadding="2" style="background-size: cover; background-repeat: no-repeat; background-position: center;">
    ...
    <tr>
        <td style="color: #000; font-size: 14px;">You are receiving this email because we received a password reset request for your account.</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="color: #000; font-size: 14px;">If you did not request a password reset, no further action is required.</td>
    </tr>
    <tr>
