...
class CreateTrnExpenseTransactionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trn_expense_transaction', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('user_id');
            $table->unsignedBigInteger('expense_sub_id');
    ...
    {
        Schema::dropIfExists('trn_expense_transaction');
    }
}
